...
function searchAll(keyword){
	...
	document.write("<center><h3>Resultados <b>"+(display_start+1)+"-"+(displast)+"</b> de <b>"+sites+"</b> para <b>"+keyword+"</b> Tiempo de busqueda <b>"+((timeB-timeA)/1000)+"</b> segundos.</h3></center>")

	if (displast>sites && finds!=0) displast=sites+1


	if (finds==0) {
		document.write("<h3><font color=green>No se encontro <b>''"+keyword+"''</b></font></h3>"+
...
function AddBody() {
	...
	templateBody()
	document.write( " <form name='searchform' method='post' action='javascript:doSearch()'><table border='0px' width='80%'><tr><td align='center'><font face='Arial, Helvetica, sans-serif' size='3'><input name='searchwords' type='text' size='25' >&nbsp;&nbsp;<a href='javascript:doSearch()'>"+ButtonCode+"</a></font></td></tr></table></form>")
